...
export declare class FsDatePickerHeaderComponent implements OnChanges, AfterViewInit {
    private _elRef;
    viewMode: string;
    minYear: number;
    maxYear: number;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<FsDatePickerHeaderComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<FsDatePickerHeaderComponent, "fs-date-picker-header", never, { "viewMode": "viewMode"; "minYear": "minYear"; "maxYear": "maxYear"; "disabledDays": "disabledDays"; "calendarDate": "calendarDate"; }, { "monthChange": "monthChange"; "yearChange": "yearChange"; "goNextMonth": "goNextMonth"; "goPrevMonth": "goPrevMonth"; "viewModeChange": "viewModeChange"; }, never, never>;
}
export {};
